...
kouko_http_nochange_request_count{{status_code="200", method="GET", path="announce"}} {}
kouko_http_cache_hit_request_count{{status_code="200", method="GET", path="announce"}} {}
kouko_http_request_count{{status_code="200", method="GET", path="announce"}} {}
kouko_http_request_duration_sum{{status_code="200", method="GET", path="announce"}} {}
